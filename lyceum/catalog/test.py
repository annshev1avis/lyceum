...
class ModelsTests(TestCase):
    ...
    def test_creating_tag(self):
        ...
        self.assertEqual(initial_amount + 1, catalog.models.Tag.objects.count())
    ...
    def test_creating_category(self):
        ...
        self.assertEqual(initial_amount + 1, catalog.models.Category.objects.count())
    ...
    def test_creating_category_wrong_weight_validator(self):
        ...
        self.assertEqual(initial_amount, catalog.models.Category.objects.count())
    ...
    def test_creating_item(self):
        ...
        self.assertEqual(initial_amount + 1, catalog.models.Item.objects.count())
